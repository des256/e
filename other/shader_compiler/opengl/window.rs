...
impl Window {
    ...
    pub fn update_swapchain_resources(&mut self,_r: Rect<isize,usize>) {
    }
    ...
    pub fn acquire_next(&self,_signal_semaphore: &Semaphore) -> usize {
    ...
    pub fn present(&self,_index: usize,_wait_semaphore: &Semaphore) {
        unsafe {
            sys::glFlush();

...
impl BaseType {
    ...
    pub fn to_rust(&self) -> &'static str {
        match self {
            ...
            BaseType::Vec2U64 => "Vec2<u64>",
            BaseType::Vec2I8 => "Vec2<i8>",
            BaseType::Vec2I16 => "Vec2<i16>",
            BaseType::Vec2I32 => "Vec2<i32>",
            BaseType::Vec2I64 => "Vec2<i64>",
            ...
            BaseType::Vec3U64 => "Vec3<u64>",
            BaseType::Vec3I8 => "Vec3<i8>",
            BaseType::Vec3I16 => "Vec3<i16>",
            BaseType::Vec3I32 => "Vec3<i32>",
            BaseType::Vec3I64 => "Vec3<i64>",
            ...
            BaseType::Vec4U64 => "Vec4<u64>",
            BaseType::Vec4I8 => "Vec4<i8>",
            BaseType::Vec4I16 => "Vec4<i16>",
            BaseType::Vec4I32 => "Vec4<i32>",
            BaseType::Vec4I64 => "Vec4<i64>",
            BaseType::Vec4F16 => "Vec4<f16>",
            BaseType::Vec4F32 => "Vec4<f32>",
            BaseType::Vec4F64 => "Vec4<f64>",
            BaseType::ColorU8 => "Color<u8>",
            BaseType::ColorU16 => "Color<u16>",
            BaseType::ColorF16 => "Color<f16>",
            BaseType::ColorF32 => "Color<f32>",
            BaseType::ColorF64 => "Color<f64>",
        }    
    }

...
pub struct GraphicsPipeline {
    ...
    pub(crate) _pipeline_layout: Rc<PipelineLayout>,
    pub(crate) shader_program: sys::GLuint,
    pub(crate) topology: sys::GLenum,
    pub(crate) _restart: PrimitiveRestart,
    pub(crate) _patch_control_points: usize,
    ...
    pub(crate) _rasterization_samples: usize,
    pub(crate) _sample_shading: SampleShading,
    ...
    pub(crate) blend: Option<(sys::GLenum,sys::GLenum,sys::GLenum,sys::GLenum,sys::GLenum,sys::GLenum)>,

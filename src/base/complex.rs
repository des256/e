...
impl<T: Mul<T,Output=T> + Add<T,Output=T> + Sub<T,Output=T>> Mul<Complex<T>> for Complex<T> {
    type Output = Self;
...
impl<T: Mul<T,Output=T> + Add<T,Output=T> + Sub<T,Output=T>> MulAssign<Complex<T>> for Complex<T> {
